...
type ProductFormGroupContent = {
  ...
  disponibility: FormControl<IProduct['disponibility']>;
  description: FormControl<IProduct['description']>;
  restaurant: FormControl<IProduct['restaurant']>;
};
...
export class ProductFormService {
  createProductFormGroup(product: ProductFormGroupInput = { id: null }): ProductFormGroup {
    ...
    return new FormGroup<ProductFormGroupContent>({
      ...
      disponibility: new FormControl(productRawValue.disponibility, {
        validators: [Validators.required],
      }),
      description: new FormControl(productRawValue.description, {
        validators: [Validators.maxLength(1000)],
      }),
      restaurant: new FormControl(productRawValue.restaurant),
    });
  }
