...
import static noah.bompard.coopcycle.web.rest.TestUtil.sameNumber;
...
class ProductResourceIT {
    ...
    @Test
    void checkDisponibilityIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().collectList().block().size();
        // set the field null
    ...
    void getAllProducts() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].disponibility")
            .value(hasItem(DEFAULT_DISPONIBILITY.toString()))
    ...
    void getProduct() {
        ...
        webTestClient
            ...
            .jsonPath("$.disponibility")
            .value(is(DEFAULT_DISPONIBILITY.toString()))
            .jsonPath("$.description")
