...
describe('Product e2e test', () => {
  ...
  const productSample = { price: 651012659, disponibility: 'UNAVAILABLE' };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="price"]`).type('241953426').should('have.value', '241953426');

      cy.get(`[data-cy="disponibility"]`).select('UNAVAILABLE');

      cy.get(`[data-cy="description"]`).type('Shirt Personal b').should('have.value', 'Shirt Personal b');
