...
describe('Restaurant e2e test', () => {
  ...
  const restaurantSample = { restaurantId: 96482, name: 'input de lavender' };
  ...
  describe('new Restaurant page', () => {
    ...
    it('should create an instance of Restaurant', () => {
      cy.get(`[data-cy="restaurantId"]`).type('5772').should('have.value', '5772');

      cy.get(`[data-cy="name"]`).type('Buckinghamshire lavender tangible').should('have.value', 'Buckinghamshire lavender tangible');

      cy.get(`[data-cy="description"]`).type('Beauty').should('have.value', 'Beauty');
